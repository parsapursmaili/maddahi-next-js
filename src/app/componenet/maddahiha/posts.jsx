        ...
        >
          {post.thumb && (
            <Image
              ...
              src={
                post.thumb
                  ? `https://besooyeto.ir/maddahi/wp-content/uploads/${
                      post.thumb.split(".")[0]
          ...
          <h2
            ...
            className={`[line-height:50px] flex inline cursor-pointer text-white text-[10px] lg:text-[15px] font-semibold mb-2  ${
              index == i ? "bounce" : ""
            } `}
          >
            {post.post_title}
