 ...
 useEffect(() => {
  ...
  function set(){
    ...
    useEffect(()=>{
      ...
      selectedUser.term_id!=0?params.set('maddah',selectedUser.term_id):params.delete('maddah');

      reason.term_id!=0?params.set('monasebatha',reason.term_id):params.delete('monasebatha');
  ...
  useEffect(()=>{
    ...
    if(control.current.page==1&&control.current.rand==0&&control.current.selectedUser==0&&control.current.reason==0&&control.current.squery.length==0){control2.current.page=5;setNTF(1);}
